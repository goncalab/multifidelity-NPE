...
class SIR_lf(Prior):
    ...
    def summary_statistics(self, n_simulations, prior):
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig("./mf_npe/simulator/task7/images/subsampled_sir_LF.png", dpi=300)
            plt.savefig("./mf_npe/simulator/task7/images/subsampled_sir_LF.pdf", dpi=300)
            plt.close()
        except Exception:
            pass
    ...
    def sir_ode(self, t, y):
        ...
        du_3 = torch.tensor([0]).expand_as(du_1)
    ...
    def simulator(self, parameters):
        ...
        plt.tight_layout()
        plt.savefig('./mf_npe/simulator/task7/images/simulated_sir_LF.png')
        plt.savefig('./mf_npe/simulator/task7/images/simulated_sir_LF.pdf')
        plt.close()
