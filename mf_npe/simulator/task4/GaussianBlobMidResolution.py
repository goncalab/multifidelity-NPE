...
class GaussianBlobMidResolution(Prior):
    ...
    def __init__(self, config_data):
        ...
        self.x_dim_mid = config_data['x_dim_mid']
        ...
        self.lf_img_width = int(np.sqrt(self.x_dim_mid))
    ...
    def simulator(self, thetas: torch.Tensor) -> torch.Tensor:
        ...
        for t in thetas.numpy():
            ...
            img = _simulate_blob(xoff, yoff, gamma,
                                image_size=self.lf_img_width, sigma=12.0, # if 16*16, then image_size=16
